...
<head>
    ...
    <title><fmt:message key="pixy_baba_somateam"></fmt:message></title>
    <script src="/static/js/font_lct.js"></script>
    <link rel="stylesheet" type="text/css" href="/static/css/recruitment.css?ddd=8217">

</head>

<body class="language_${language}" language="${language}" phone="${phone_number}" >
        ...
        <div class="contain">
            <div class="homepage">
                <div class="message_content">
                    ...
                    <br>
                    <p class="text"><fmt:message key="pixy_recruit_address"></fmt:message></p>
                    <br>
                    <p class="text direction"><fmt:message key="pixy_recruit_content_an"></fmt:message></p>
                ...
                <div class="form_bg">
                   <div class="form_content">
                        ...
                        <div class="input_container">
                            <input id="email" placeholder='<fmt:message key="pixy_recruit_email"></fmt:message>' class="input_style form_input mr_bottom" />
                        ...
                        <div class="gender_contain">
                            ...
                            <label class="male"><span class="gender"><div class="ic_gender off" data-gender="2"></div><fmt:message key="pixy_common_male"></fmt:message></span></label>
                            <label><span class="gender"><div class="ic_gender off" data-gender="1"></div><fmt:message key="pixy_common_female"></fmt:message></span></label>
                        </div>
                        <div class="input_container">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(".btn_submit").click(function () {
                ...
                var $body = $("body");
                var phone_number = $body.attr("phone") || "";
                ...
                $(".btn_yes").click(function() {
                    $.ajax({
                        url: "/public/broadcasterRecruitSubmit",
                        type: "POST",
                        ...
                        success: function (cont, txtStatus, xhr) {
                            if (xhr.status == 200) {
                                ...
                                $(".successTip").show();
                                $(".popUp_contain").hide();
                            } else if (xhr.status == 207 || 'email_has_been_used' === cont) {
                                console.log("邮箱已注册");
                                $(".popUp_contain").hide();
                            }
                        }
