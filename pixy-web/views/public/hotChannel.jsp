...
<div id="wrap">
        <div class="video-container">
            <a class="video-wrapper-play onClickPixyDownLoad">
            ...
            <div class="video-top">
                ...
                <a class="video-top1 onClickPixyDownLoad" >
                    <div class="video-owner download-pixy" >
                        <div class="video-owner-line1"></div>
                        <img class="video-owner-avatar" id="currentChannelAvatar" src="/static/images/ic_avatar@3x.png" >
                    ...
                    <div class="video-fan-list">
                        <c:forEach var="d" varStatus="id" items="${fanList}">
                            <div class="video-fan1">
                                <img class="video-fan" src="/static/images/ic_avatar@3x.png" id="fanListUid${d.uid}">
                            </div>
                        </c:forEach>

                        <div id="fanListUidAvatarImg" style="overflow: hidden;display: none;">
                            <c:forEach var="d" varStatus="id" items="${fanList}">
                                <img dsrc="${d.avatar}" mid="fanListUid${d.uid}">
                            </c:forEach>
                            <img dsrc="${currentChannel.ownerAvatar}" mid="currentChannelAvatar" >
                        </div>
                ...
                <div class="video-top2">
                    <a class="star onClickPixyDownLoad" >
    ...
    <div class="bottom-down">
        ...
        <div class="channel-list">
            ...
            <c:forEach var="d" varStatus="id" items="${channelList}">
                <a class="onClickPixyDownLoad channel-item channel-item${id.index%2}" ownerUid="${d.ownerUid}">
...
<script>
    ...
    jQuery(document).ready(function () {
        ...
        $('#fanListUidAvatarImg img').each(function(){
            var $img = $(this);
            var mid = $img.attr('mid');
